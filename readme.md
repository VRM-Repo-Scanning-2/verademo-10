...
Blab-a-Gag is a fairly simple forum type application which allows: test12 3 4 5 6 7 8 9 10 11 sf 5 jj testwsdswdfdsf r

- users to post a one-liner joke..
- users to follow the jokes of other users or not (listen or ignore). teset test
